// src/pages/products/LabEquipment.js
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="ZONWON Lab Equipment Banner"
      >
        {/* Background overlay - only visible on mobile */}
        <div className="absolute inset-0 bg-black bg-opacity-20 sm:bg-opacity-0" />
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">
              ZONWON - Laboratory Testing Excellence
            </h2>
            <p className="text-gray-700 mb-8 leading-relaxed">
              We introduce the world's leading technology for Laboratory testing equipment for
              Polymer Material and Liquid testing. From Zonwon we offer IV Tester and AA Analyser
              of high-standard designed in Germany, our range of IV testers starts from Manual,
              Semi-automatic, and fully automatic - apart from Testing equipment we also offer
              other Laboratory peripherals for sample preparation, testing and cleaning.
            </p>
              ...
              <div className="md:w-1/2">
                <div className="bg-gray-50 p-6 rounded-lg shadow-md h-full">
                  ...
                  <p className="text-gray-700 mb-6">
                    GC112N Gas chromatograph is one of widely used analytical instruments. It has
                    become an ideal analytical instrument for separation or analysis in various
                    fields.
                  </p>
                  <Link
            ...
            <div className="mb-12">
              ...
              {activeInfoTab === 'company' && (
                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                  <h5 className="font-semibold text-gray-800 mb-4">
                    Benefits /Customer Prefer Zonwon Because Of:
                  </h5>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <div className="text-green-500 mr-3 mt-1">➤</div>
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        Zonwon equipment are Manual, Semi-Automatic, and Fully automatic
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="text-green-500 mr-3 mt-1">➤</div>
              ...
              {/* Equipment Tab (kept commented as in your file) */}
              {/*
              {activeInfoTab === 'preform' && (
                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                  <h5 className="font-semibold text-gray-800 mb-4">
                    Our laboratory equipment offers significant advantages:
                  </h5>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <div className="text-green-500 mr-3 mt-1">➤</div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-block">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-green-600 mx-auto mb-6" />
            </div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive range of cutting-edge industrial solutions designed to
              optimize your production efficiency and enhance manufacturing capabilities
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/injection-molding')}
            >
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/beverage-filling')}
            >
              <div className="relative h-56 overflow-hidden">
                <img
                  src={imgP2}
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/pet-preform')}
            >
              <div className="relative h-56 overflow-hidden">
                <img
                  src={imgP3}
            ...
            {/* Lab Equipment (kept commented out, as in your snippet) */}
            {/*
            <div
            ...
            */}
            ...
            <div
              ...
              tabIndex={0}
              onKeyDown={(e) =>
                e.key === 'Enter' && handleNavigation('/products/integrated-plastics')
              }
            >
              <div className="relative h-56 overflow-hidden">
                <img
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Integrated Plastics- Patented, recyclable plastic container solutions for
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/caps-mold')}
            >
              <div className="relative h-56 overflow-hidden">
                <img
                  src={imgP6}
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/packaging-mold')}
            >
              <div className="relative h-56 overflow-hidden">
                <img
                  src={imgP7}
            ...
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === 'Enter' && handleNavigation('/products/packaging-systems')}
            >
              <div className="relative h-56 overflow-hidden">
                <img
                  src={imgP8}
