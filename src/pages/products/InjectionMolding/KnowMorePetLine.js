// Updated NetstatPetLine.js
import React, { useState , useEffect} from 'react';
import ContactCTA from '../../../components/home/ContactCTA'; // Import from your existing file
import factoryImage from '../../../assets/images/know_more/pet.webp'; // Import from your existing file
import petLineImage from '../../../assets/images/know_more/img1.png'; // Import from your existing file
  ...
  <div className="absolute inset-0 bg-black bg-opacity-20 sm:bg-opacity-0"></div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* THE MOST ADVANCED AND HIGHLY PRODUCTIVE SYSTEM */}
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">THE MOST ADVANCED AND HIGHLY PRODUCTIVE SYSTEM IN THE WORLD</h2>
              <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
                Netstal PET-LINE offers the broadest compatibility with existing side-entry moulds and post-cooling stations. The system impresses with 
                legendary output, exceptional energy efficiency, optimised processing of PET recyclates and an intuitive operating unit.
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-700">Clamping force sizes: 3000 kN, 4000 kN, 5000 kN</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Up to 144 cavities</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Electric clamping unit with 1.9 s lock-to-lock time</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Side removal unit with up to 4 post-mold cooling stations</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Energy efficient, two-stage injection unit</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">New PETX screw for optimum processing of all PET types – with and without additives</span>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Latest generation Axos controller with innovative control concept</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Smart Operation for simpler, faster and safer start-up and production</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Lowest energy consumption on the market due to energy recuperation</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="text-blue-500 mt-1">•</span>
                      <span className="text-gray-700">Comprehensive options package for custom enhancements</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg">
                <iframe 
                  ...
                  width="560" 
                  height="315" 
                  src="https://www.youtube.com/embed/eIvSqklTqyE?si=gQJyvCQfPsP066lp"
