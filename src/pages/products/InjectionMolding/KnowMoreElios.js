...
import factoryImage from '../../../assets/images/know_more/Elios.webp'; // Import from your existing file
import petLineImage from '../../../assets/images/know_more/img4.png'; // Import from your existing file
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-base text-gray-700 leading-relaxed max-w-5xl">
              Featuring innovative drive technology, the Elios series is the performance benchmark for thin-walled packaging. High-performance, speed, precision and an energy efficiency that is still unmatched on the market are the stand out qualities. Together with Netstal's proven precision, reliability and user friendliness, you obtain a premium system to successfully realize your thin-walled applications.
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <span className="text-gray-700 text-sm leading-tight">Clamping force range 4500 - 10000 kN</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Short dry cycle times between 1.5 and 2.2 seconds</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Generous mold installation dimensions</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Stable design</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">High-performance injection units</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Top precision and repeatability</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Flexible equipment options</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg">
                <iframe 
                  ...
                  width="560" 
                  height="315" 
                  src="https://www.youtube.com/embed/ZjKFALBeewA?si=FhHHo7QQR6ORe2XS"
