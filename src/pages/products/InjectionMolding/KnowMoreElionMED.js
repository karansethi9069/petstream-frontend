...
import factoryImage from '../../../assets/images/know_more/ElionMED.webp'; // Import from your existing file
import petLineImage from '../../../assets/images/know_more/img3.png'; // Import from your existing file
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 uppercase tracking-wide">
              THE ALL-ELECTRIC INJECTION MOLDING MACHINE FOR MEDICAL TECHNOLOGY APPLICATIONS OF THE HIGHEST ORDER
            </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <span className="text-gray-700 text-sm leading-tight">Clamping force range: 800 - 2800 kN</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Electric clamping unit for the fastest cycle times</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">All-electric injection unit with integrated force measurement for maximum shot-to-shot consistency and a stable part weight</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Freely programmable Axos controller for optimum flexibility and user-friendliness</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Optimal energy efficiency due to the recuperation of kinetic energy</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Maximum reliability and system availability</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-red-500 text-lg mt-0.5">•</span>
                      <span className="text-gray-700 text-sm leading-tight">Smart Operation: Reliable embedding of handling specifications within the machine control system</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg">
                <iframe 
                  ...
                  width="560" 
                  height="315" 
                  src="https://www.youtube.com/embed/fZ19sM7-KQw?si=sLDdz6miklhH6meu"
